...
// Wrap with el-col if span is not 24
...
function buildElUploadChild(conf) {
  ...
  if (conf.showTip) list.push(`<div slot="tip" class="el-upload__tip">File {conf.accept} that do not exceed {conf.fileSize}{conf.sizeUnit}</div>`)
  return list.join('\n')
}
