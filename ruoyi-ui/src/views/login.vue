  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item style="width:100%;">
        ...
        >
          <span v-if="!loading">by Dan Recorded</span>
          <span v-else>by Dan Recorded in...</span>
        </el-button>
        <div style="float: right;" v-if="register">
          <router-link class="link-type" :to="'/register'">Register immediately.</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  The bottom  -->
