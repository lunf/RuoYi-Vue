    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.placeholder!==undefined" label="Placeholder reminder">
          ...
          <el-form-item v-if="activeData.tag==='el-checkbox-group'" label="At least">
            <el-input-number
          ...
          <el-form-item v-if="activeData['active-text'] !== undefined" label="Open prompt">
            <el-input v-model="activeData['active-text']" placeholder="Please enter the opening prompt" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-text'] !== undefined" label="Close prompt">
            <el-input v-model="activeData['inactive-text']" placeholder="Please enter close prompt" />
          </el-form-item>
          <el-form-item v-if="activeData['active-value'] !== undefined" label="Open value">
            <el-input
              :value="setDefaultValue(activeData['active-value'])"
              placeholder="Please enter an open value"
          ...
          <el-form-item v-if="activeData.tag === 'el-color-picker'" label="Color format">
            <el-select
              ...
              placeholder="Please choose color format"
              :style="{ width: '100%' }"
          ...
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Allow to select multiple">
            <el-switch v-model="activeData.props.props.multiple" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Show full path">
            <el-switch v-model="activeData['show-all-levels']" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Can be filtered">
            <el-switch v-model="activeData.filterable" />
          </el-form-item>
          <el-form-item v-if="activeData.clearable !== undefined" label="Can it be emptied">
            <el-switch v-model="activeData.clearable" />
          </el-form-item>
          <el-form-item v-if="activeData.showTip !== undefined" label="Show hint">
            <el-switch v-model="activeData.showTip" />
          </el-form-item>
          <el-form-item v-if="activeData.multiple !== undefined" label="Multiple selection files">
          ...
          <el-form-item v-if="activeData.disabled !== undefined" label="Allow to disable">
            <el-switch v-model="activeData.disabled" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-select'" label="Searchable">
            <el-switch v-model="activeData.filterable" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-select'" label="Allow to select multiple">
            <el-switch v-model="activeData.multiple" @change="multipleChange" />
          </el-form-item>
          <el-form-item v-if="activeData.required !== undefined" label="Is it required">
          ...
          <template v-if="activeData.layout === 'colFormItem'">
            ...
            >
              ...
              <el-form-item label="Error message" style="margin-bottom:0">
                <el-input v-model="item.message" placeholder="Please enter the wrong prompt" />
              </el-form-item>
            </div>
            <div style="margin-left: 20px">
